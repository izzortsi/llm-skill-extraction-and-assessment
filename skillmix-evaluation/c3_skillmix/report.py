...
Usage:
    python -m c3_skillmix.report --results-dir skillmix-results/
"""
...
def main() -> None:
    ...
    Delegates to c4_cli.report for argument parsing and execution.
    Prefer using ``python -m c4_cli.main report`` instead.
    """
    from c4_cli.report import run
