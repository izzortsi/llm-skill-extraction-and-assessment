...
Usage:
    python -m skillmix.harness --skills-dir composed-skills/ --tasks tasks.json --provider openai --model qwen3:0.6b --base-url http://localhost:11434/v1
"""
...
from evaluation.skill_injection import format_skill_for_system_prompt, get_default_system_prompt
