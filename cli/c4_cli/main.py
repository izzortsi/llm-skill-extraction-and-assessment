...
Examples:
  ...
  python3 -m c4_cli.main run --stages 1-4 --profile my-experiment
  python3 -m c4_cli.main run --stages evaluation
  python3 -m c4_cli.main run --interactive
  python3 -m c4_cli.main config list
...
""",
    ...
    if args.command == "run":
        ...
        from c4_cli.command_run import main as cmd_main
        cmd_main()

    elif args.command == "config":
        sys.argv = ["llm-skills config"] + args.args
        from c4_cli.command_config import main as cmd_main
        cmd_main()
