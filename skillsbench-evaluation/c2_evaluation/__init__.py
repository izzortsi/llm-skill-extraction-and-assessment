"""c2_evaluation -- skill evaluation components.

LLM-as-judge, proof verification, skill injection, effectiveness metrics,
trial results, and experiment configuration.

Config/data classes re-exported from c0_config for backwards compatibility.
"""
...
try:
    from c0_config.trial_result import TrialResult, BenchmarkRecord, load_progress_records
...
try:
    from c2_evaluation.proof_verifier import ProofVerifier
...
try:
    from c2_evaluation.effectiveness import (
