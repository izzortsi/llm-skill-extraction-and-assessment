...
export PYTHONPATH="${PY_REPO_ROOT}/skillsbench-evaluation${SEP}${PY_REPO_ROOT}/text-extraction-pipeline${SEP}${PY_REPO_ROOT}/shared-data${SEP}${PY_REPO_ROOT}/llm-providers${SEP}${PYTHONPATH:-}"
