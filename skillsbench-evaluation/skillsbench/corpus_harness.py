...
from schemas.extracted_task import ExtractedTask
from schemas.extracted_skill import ExtractedSkill
...
# ---------------------------------------------------------------------------
# CLI (delegates to cli.run_skillsbench; kept here for backwards compat)
# ---------------------------------------------------------------------------

def main() -> None:
    """CLI entry point -- delegates to cli.run_skillsbench.main()."""
    from cli.run_skillsbench import main as _cli_main
    _cli_main()
