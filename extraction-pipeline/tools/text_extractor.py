...
Usage:
    python -m providers.text_extractor extract input.pdf -o output/
    python -m providers.text_extractor clean input.txt -o output/
    python -m providers.text_extractor pipeline input.pdf -o output/
"""
