...
""",
    ...
    if args.command == "extract-text":
        ...
        from tools.text_extractor import main as cmd_main
        cmd_main()
        ...
        from extraction.passage_extractor import main as cmd_main
        cmd_main()

    elif args.command == "extract-tasks":
        sys.argv = ["extract-tasks"] + args.args
        from extraction.task_extractor import main as cmd_main
        cmd_main()

    elif args.command == "capture-traces":
        sys.argv = ["capture-traces"] + args.args
        from extraction.trace_runner import main as cmd_main
        cmd_main()

    elif args.command == "extract-skills":
        sys.argv = ["extract-skills"] + args.args
        from extraction.skill_extractor import main as cmd_main
        cmd_main()

    elif args.command == "verify-skills":
        sys.argv = ["verify-skills"] + args.args
        from extraction.skill_verifier import main as cmd_main
        cmd_main()

    elif args.command == "compose-skills":
        sys.argv = ["compose-skills"] + args.args
        from composition.generator import main as cmd_main
        cmd_main()

    elif args.command == "traceability-report":
        sys.argv = ["traceability-report"] + args.args
        from extraction.traceability_report import main as cmd_main
        cmd_main()

    elif args.command == "export-csv":
        sys.argv = ["export-csv"] + args.args
        from extraction.csv_export import main as cmd_main
        cmd_main()

    elif args.command == "format":
        sys.argv = ["format"] + args.args
        from tools.skill_formatter import main as cmd_main
        cmd_main()
