...
from tools.skill_registry import Skill, SkillRegistry
...
class SemanticCompositor:
    ...
    Uses the provider abstraction from providers.providers for LLM calls.
    """
...
Now create the composite skill:"""
    ...
    def _call_llm(self, prompt: str) -> str:
        ...
        Uses the provider abstraction from providers.providers.
