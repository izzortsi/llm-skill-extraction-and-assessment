...
from c1_types.extracted_skill import ExtractedSkill, load_extracted_skills, save_extracted_skills
...
Examples:
  ...
  python -m c1_tools.skill_formatter skills-to-md --input skills.json --output-dir skills-md/

  # Skills markdown directory -> JSON
  python -m c1_tools.skill_formatter skills-to-json --input-dir skills-md/ --output skills.json

  # Tasks JSON -> markdown directory
  python -m c1_tools.skill_formatter tasks-to-md --input tasks.json --output-dir tasks-md/

  # Tasks markdown directory -> JSON
  python -m c1_tools.skill_formatter tasks-to-json --input-dir tasks-md/ --output tasks.json
""",
    )
