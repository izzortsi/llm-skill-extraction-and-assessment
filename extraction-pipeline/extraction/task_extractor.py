...
def load_text_from_file(filepath: Path) -> str:
    ...
    if ext == ".pdf":
        from tools.text_extractor import convert_pdf
...
def load_extracted_tasks(filepath: Path) -> List[ExtractedTask]:
    ...
    """
    # TODO: import from llm-providers
    # from providers.schema_validator import validate_tasks_json
...
""",
    ...
    if args.passages:
        ...
        from extraction.passage_extractor import load_passages
